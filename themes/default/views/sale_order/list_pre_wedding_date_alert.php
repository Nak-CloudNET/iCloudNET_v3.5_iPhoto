...
<script>
    $(document).ready(function () {
        var oTable = $('#SLData').dataTable({
            ...
            'sAjaxSource': '<?=site_url('sale_order/getPreWeddingAlert' . ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
			"bAutoWidth": false ,
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": fld}, null, null, null, null, null, {"mRender": fld},{"mRender": fld},{"mRender":  issue_status }, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": so_status}/* , {"bSortable": false} */],
            ...
            {column_number: 7, filter_default_label: "[<?=lang('date');?> (yyyy-mm-dd)]", filter_type: "text", data: []},
            {column_number: 8, filter_default_label: "[<?=lang('date');?> (yyyy-mm-dd)]", filter_type: "text", data: []},
			{column_number: 9, filter_default_label: "[<?=lang('order_status');?>]", filter_type: "text", data: []},
            {column_number: 11, filter_default_label: "[<?=lang('deposit');?>]", filter_type: "text", data: []},
            {column_number: 12, filter_default_label: "[<?=lang('balance');?>]", filter_type: "text", data: []},
                ...
                <div class="table-responsive">
                    <table id="SLData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <th><?php echo $this->lang->line("prewedding_date"); ?></th>
                            <th><?php echo $this->lang->line("wedding_date"); ?></th>
