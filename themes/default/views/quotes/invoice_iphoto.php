            ...
            <table class="table">
                <thead>
                            ...
                            <div class="row" style="margin-top: 0px !important;">
                                <center>
                                    <?php if(!empty($billers->logo)) { ?>
                                        <img class="img-responsive myhide" src="<?= base_url() ?>assets/uploads/logos/<?= $billers->logo; ?>" id="hidedlo" style=" margin-top: -10px;" />
                                    <?php } ?>
                                </center>
                            </div>
                            <div class="row" style="margin-top: 0px !important;">
                                <div class="col-sm-2 col-xs-2"></div>
                                <div  class="col-sm-8 col-xs-8 company_addr "  style="margin-top: -20px !important;">
                    ...
                    <tr class="border thead print" style="background-color: rgb(78,41,5) !important; color: #FFF !important;">
                        ...
                        <?php if ($Settings->product_discount) { ?>
                            <th  class="discount">បញ្ចុះតម្លៃ<br /><?= strtoupper(lang('discount')) ?></th>
                        <?php } ?>
                        <?php if ($Settings->tax1) { ?>
                            <th class="tax" style="width: 10%">ពន្ធទំនិញ<br /><?= strtoupper(lang('tax')) ?></th>
                        <?php } ?>
                ...
                foreach ($rows as $row) {
                    ...
                    <tr class="border">
                        ...
                        <td style="vertical-align: middle;">
                            <?=$row->product_noted;?>
                            <?php if(!empty($row->location) && $row->location!='undefined' ) { ?>
                                <b>ទីតាំង</b> <?= str_ireplace('<p>','',$row->location) ?>
                            <?php } ?>
                        </td>
                        ...
                        <?php if ($row->item_discount) {?>
                            <td  class="discount" style="vertical-align: middle; text-align: center">
                                <?php
                        ...
                        <?php } ?>
                        <?php if ($row->item_tax) {?>
                            <td class="tax" style="vertical-align: middle; text-align: center">
...
//                    }
                ...
                $col =3;
                $col2=2;
                 if($invs->total_discount){$col=3;$col2=2;}
                if($invs->product_tax){$col=3;$col2=2;}
                if($invs->total_discount>0 && $invs->product_tax>0 ){$col=3;$col2=3;}
                if($invs->total_discount==0 && $invs->product_tax==0 ){$col=2;$col2=2;}
                if ($discount != 0) {
                    $col = 3;
                }
                ...
                if ($invs->grand_total != $invs->total) { ?>
                    <tr class="border-foot">
                        <td rowspan = "<?= $row; ?>" colspan="<?= $col2 ?>" style="border-left: 1px solid #FFF !important; border-bottom: 1px solid #FFF !important;">
                            <?php if (!empty($billers->invoice_footer)) { ?>
                                <p ><strong><u>Note:</u></strong></p>
                                <p style="margin-top:-5px !important; line-height: 2"><?= $billers->invoice_footer ?></p>
                            <?php } ?>
                        </td>
